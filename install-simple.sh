...
def main():
    ...
    if success:
        ...
        print("📖 Read AGENTS.md for usage instructions")
...
# Simple installer for OpenCode Agent System

echo "🚀 Installing OpenCode Agent System..."
...
import sys
sys.path.insert(0, '.')
from install_simple import SimpleAgentInstaller
installer = SimpleAgentInstaller('.')
installer.install()
"

echo "✅ Installation complete!"
echo "📖 Read AGENTS.md for usage instructions"
echo "🚀 Run: python3 .opencode/init.py"